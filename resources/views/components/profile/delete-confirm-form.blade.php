...
<div class="w-full max-w-sm">
    <h1 class="mb-4 text-lg">{{ __('easy-auth::profile.delete_heading') }}</h1>

    <p class="mb-4 text-sm">{{ __('easy-auth::profile.delete_description') }}</p>
    ...
    <form method="POST" action="{{ route('profile.delete') }}">
        ...
        @stack('easy-auth::components.profile.delete-confirm-form.after-fields')
